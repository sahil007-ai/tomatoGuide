...
class PomodoroTimer:
    def __init__(self, root):
        ...
        right_frame.pack(side="left", fill="y", padx=(10, 20), pady=10)
        ...
        self.webcam_label = ctk.CTkLabel(left_frame, text="")
    ...
    def update_webcam(self):
        try:
            ...
            ctk_img = ctk.CTkImage(light_image=img, dark_image=img, size=(600, 360))
